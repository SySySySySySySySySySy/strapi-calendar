			...
			<Grid.Item s={6}>
				<Field.Root style={{ width: "100%" }} required>
					<Field.Label>
						{formatMessage({
							id: getTranslation(
								"view.settings.section.general.collection.label",
							),
			...
			<Grid.Item col={3} s={12}>
				<Field.Root style={{ width: "100%" }}>
					<Field.Label>
						{formatMessage({
							id: getTranslation(
								"view.settings.section.general.duration.label",
							),
					...
					<SingleSelect
						onChange={(e: string) =>
							updateField({ defaultDuration: Number(e) })
						}
					...
					>
						<SingleSelectOption value="30">
							{formatMessage({
								id: getTranslation(
									"view.settings.section.general.duration.30m",
								),
						...
						<SingleSelectOption value="90">
							{formatMessage({
								id: getTranslation(
									"view.settings.section.general.duration.1.5h",
								),
			...
			<Grid.Item s={12}>
				<Field.Root style={{ minWidth: 300 }}>
					<Field.Label>
						{formatMessage({
							id: getTranslation(
								"view.settings.section.general.filter-enabled.label",
							),
					...
					<Toggle
						...
						offLabel={formatMessage({
							id: getTranslation(
								"view.settings.section.general.filter-enabled.off",
							),
							defaultMessage: "Disabled",
						})}
						onLabel={formatMessage({
							id: getTranslation(
								"view.settings.section.general.filter-enabled.on",
							),
