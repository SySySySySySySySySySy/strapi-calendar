...
const extensionSystem = {
    ...
    registerExtensions: (extensions) => {
        extensions.forEach((extension) => {
            extensionSystem.registerExtension(extension.id, extension.name, extension.startFields, extension.endFields, extension.startHandler, extension.endHandler);
        });
    },
    /**
...
exports.default = extensionSystem;
